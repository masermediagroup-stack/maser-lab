...
export const PROCEDURAL_MATERIALS: MaterialDefinition[] = [
  {
    ...
    recommendedComponents: ["card", "button", "badge", "navigation", "input", "avatar"],
    poorFitComponents: [],
  ...
  },
  {
    ...
    recommendedComponents: ["card", "image-frame", "section-background"],
  ...
  },
  {
    ...
    recommendedComponents: ["card", "section-background", "button"],
  ...
  },
  {
    ...
    poorFitComponents: ["section-background"],
  ...
  },
  {
    ...
    recommendedComponents: ["section-background", "loader"],
  ...
  },
  {
    ...
    recommendedDither: ["blue-noise", "bayer"],
    recommendedComponents: ["section-background", "card"],
  ...
  },
  {
    ...
    poorFitComponents: ["scrollbar", "section-background"],
  ...
  },
  {
    ...
    recommendedComponents: ["card", "section-background", "loader", "image-frame"],

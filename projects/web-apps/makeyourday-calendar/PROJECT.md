...
| Month **calendar icon** (next to day dial) | Opens full **month grid**; selecting a day opens the day **menu** (Add / Show events) |
| **Show events** list | Tap an event → detail view with **edit** and **delete** in panel header |

...
```tsx
import { ChromeMarkApp } from "@/components/projects/web-apps/chromemark";
```
...
1. Copy `lab/src/components/projects/web-apps/chromemark/` to portfolio repo
...
App surface — portable unit is `ChromeMarkApp`, not the lab demo chrome.

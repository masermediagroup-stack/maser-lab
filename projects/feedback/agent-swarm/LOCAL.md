...
Open **http://localhost:3000/demos/agent-swarm**
...
npm run lint
npm run build
npm test -- src/components/projects/feedback/agent-swarm
```
...
`lab/src/components/projects/feedback/agent-swarm/`

## Spec

`projects/feedback/agent-swarm/PROJECT.md`

## Transfer

- Per-project notes: `projects/feedback/agent-swarm/TRANSFER.md`

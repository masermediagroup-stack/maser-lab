...
| Flip | One 180° turn on the cuboid, then settle (520ms, product state). Viewport expanded so lids are not cropped (FlipNoClip). Reduced: swap, no turn | Back on the wordmark, Front on the identity face. Text is the button. Swap type is black. No extra spin, no loop, no fade. |

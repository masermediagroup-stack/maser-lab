...
Lab craft cut is the default (full-bleed field + dock knobs). Open studio from the dock for the authoring shell.

Studio keyboard: `1` Overview · `2` Components · `3` Materials · `4` Presets · `5` Playground · `6` Docs

...
| Node | Name | Use |
| --- | --- | --- |
| `11:2` | GrokBot-TV-Idle-Wallpaper | Layout + lockup sizes. Live ground is a WebGL2 silk moving gradient remade from Unicorn look-only `eFskEoMG10ENKSC2rBFp` — not the SDK, not the watermark, not circle glyphs, not vgpu on this canvas. |

...
| Background | **vgpu** silk/fold moving gradient. Dark black + grey, sparse white hint. Visible autonomous drift. dpr 1.5–2. Reduced motion / pause: still. Fail = static silk wash on `#060606`. |

...
Open **http://localhost:3000/demos/meetup-loop-viz**
...
`lab/src/components/projects/display/meetup-loop-viz/`

## Spec

`projects/display/meetup-loop-viz/PROJECT.md`

## Transfer

- Per-project notes: `projects/display/meetup-loop-viz/TRANSFER.md`

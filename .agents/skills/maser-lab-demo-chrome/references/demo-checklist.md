...
- [ ] Mobile open dock is a **footer** strip (`--lab-control-dock-bottom`); product occupies the top; never a left-rail width on `<640px`
...
- [ ] Props/API note present
- [ ] No product-slug types/classes inside `demo-chrome.tsx`
- [ ] Registered in `demoRegistry`
- [ ] Prefer `/demos/[slug]` over dedicated page

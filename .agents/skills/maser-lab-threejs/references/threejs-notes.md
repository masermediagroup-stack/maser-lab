...
| Spherical CanvasTexture type | Shipped: `scroll/type-world` — two LTR quote panels in a 2:1 texture on FrontSide SphereGeometry; CSS sticky scale reveal; pointer→target→damp drag |

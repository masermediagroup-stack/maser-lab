...
- Name: summitpath-sign-up.spec.ts >> SummitPath Sign-Up Demo — State Validation >> 5. Disabled toggle — disables all form elements
- Location: e2e\summitpath-sign-up.spec.ts:157:7

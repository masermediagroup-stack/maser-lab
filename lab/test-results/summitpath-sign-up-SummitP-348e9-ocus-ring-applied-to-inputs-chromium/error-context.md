...
- Name: summitpath-sign-up.spec.ts >> SummitPath Sign-Up Demo — State Validation >> 2. Input focus — focus ring applied to inputs
- Location: e2e\summitpath-sign-up.spec.ts:75:7

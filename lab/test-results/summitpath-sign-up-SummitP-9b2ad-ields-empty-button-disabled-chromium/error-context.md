...
- Name: summitpath-sign-up.spec.ts >> SummitPath Sign-Up Demo — State Validation >> 1. Default render — section visible, fields empty, button disabled
- Location: e2e\summitpath-sign-up.spec.ts:40:7

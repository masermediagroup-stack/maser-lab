...
export function ServiceShowcaseDemo({ minimal = false }: ServiceShowcaseDemoProps) {
  ...
  return (
    <div className="maser-lab min-h-screen">
      {!minimal ? (
        <DemoControlBar className="left-4 right-4 top-4 max-h-[min(70vh,520px)] flex-col items-stretch gap-3 overflow-y-auto sm:max-h-none sm:flex-row sm:items-start sm:justify-between">
          <DemoLabBrand />

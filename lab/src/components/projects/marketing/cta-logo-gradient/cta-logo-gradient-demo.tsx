      ...
      <DemoControlMenu>
        ...
        <div>
          ...
          <p className="mt-1 text-xs leading-relaxed text-[var(--lab-text-secondary)]">
            ASCII-filled Blue-HD: water through the grain, clipped to the
            mark. Characters swim; unlit cells stay the logo. White ground.
          </p>
        </div>
        ...
        <p className="clg-notes font-mono text-[10px] leading-relaxed text-[var(--lab-text-muted)]">
          ...
          Reduced motion drops tilt only — the wash always loops. Grain
          swims (no scale bulge). Unlit cells stay Blue-HD. White ground.
          Sharp clip.
        </p>
      </DemoControlMenu>
    </div>

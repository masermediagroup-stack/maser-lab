/**
 * Official Grok Bot body picker — kept Ver 02 subset (4 silhouettes).
 ...
 * Pill, Cloud, Teardrop, and Triangle are out of the cycle.
 ...
 * Remaining bodies fill the box. Do not scale the cube up.
 */

import type { GrokShapeId } from "./grok-cycle";
import { FACE_DISC_R } from "./grok-eyes";

export const GROK_SHAPE_COUNT = 4;

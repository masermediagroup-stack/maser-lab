    ...
    controls: [
      ...
      { type: "text", key: "line2", label: "Second line", group: "content" },
      {
        ...
        options: [
          ...
          { value: "custom", label: "Custom Pixel Font" },
        ],
      },
      { type: "text", key: "customFontFamily", label: "Custom font-family", group: "content" },
      { type: "text", key: "customFontUrl", label: "Custom font URL", group: "content" },
      {
        type: "select",
        key: "customFontWeight",
      ...
      { type: "slider", key: "fontSize", label: "Font size", group: "content", min: 48, max: 240, step: 4 },
      ...
      { type: "slider", key: "cellSize", label: "Render cell override (0=auto)", group: "quality", min: 0, max: 14, step: 1 },
      { type: "slider", key: "gridPadding", label: "Grid padding", group: "quality", min: 0, max: 6, step: 1 },
      { type: "slider", key: "coverageThreshold", label: "Coverage override (0=auto)", group: "quality", min: 0, max: 0.45, step: 0.01 },

      { type: "slider", key: "animationDuration", label: "Animation Length (s)", group: "animation", min: 0.8, max: 12, step: 0.1 },
      phaseControl(),
      { type: "switch", key: "autoPlay", label: "Auto play", group: "animation" },
      { type: "switch", key: "loop", label: "Loop", group: "animation" },
      {
        type: "select",
        key: "concurrency",
        label: "Concurrency",
        group: "animation",
        options: [
          { value: "auto", label: "Auto (from length)" },
          { value: "low", label: "Low" },
          { value: "balanced", label: "Balanced" },
          { value: "high", label: "High" },
          { value: "maximum", label: "Maximum" },
      ...
      { type: "color", key: "color", label: "Color", group: "appearance" },
      { type: "slider", key: "rainbowSaturation", label: "Rainbow saturation", group: "appearance", min: 0, max: 1, step: 0.05 },
      { type: "slider", key: "rainbowBrightness", label: "Rainbow brightness", group: "appearance", min: 0.2, max: 1, step: 0.05 },
      { type: "slider", key: "rainbowSpread", label: "Rainbow spread", group: "appearance", min: 0.2, max: 2, step: 0.05 },
      { type: "slider", key: "hueSpeed", label: "Hue animation speed", group: "appearance", min: 0, max: 0.5, step: 0.01 },
      {
        type: "select",
        key: "gradientAxis",
        label: "Gradient axis",
      ...
      { type: "slider", key: "glowIntensity", label: "Landing glow intensity", group: "appearance", min: 0, max: 1, step: 0.05 },
      { type: "slider", key: "glowRadius", label: "Glow radius", group: "appearance", min: 1, max: 8, step: 0.5 },
      { type: "slider", key: "impactFlash", label: "Impact flash", group: "appearance", min: 0, max: 1, step: 0.05 },
      { type: "slider", key: "finalWordGlow", label: "Final-word glow", group: "appearance", min: 0, max: 1, step: 0.05 },
      { type: "color", key: "background", label: "Background", group: "appearance" },

      { type: "slider", key: "fallDuration", label: "Fall duration (ms)", group: "advanced", min: 600, max: 4000, step: 50 },
      { type: "slider", key: "stagger", label: "Stagger (ms)", group: "advanced", min: 0, max: 200, step: 5 },
      { type: "slider", key: "staggerRandomness", label: "Stagger randomness", group: "advanced", min: 0, max: 1, step: 0.05 },
      { type: "slider", key: "pieceSpacing", label: "Piece spacing (fall)", group: "advanced", min: 0, max: 1, step: 0.05 },
      { type: "slider", key: "spawnHeightMin", label: "Spawn height min", group: "advanced", min: 0.5, max: 3, step: 0.1 },
      { type: "slider", key: "spawnHeightMax", label: "Spawn height max", group: "advanced", min: 1, max: 4, step: 0.1 },
      { type: "slider", key: "landingDensity", label: "Landing density", group: "advanced", min: 0, max: 1, step: 0.05 },
      { type: "slider", key: "spawnSafetyMargin", label: "Spawn safety margin", group: "advanced", min: 0, max: 8, step: 1 },
      { type: "slider", key: "horizontalMovement", label: "Horizontal movement", group: "advanced", min: 0, max: 1, step: 0.05 },
      { type: "slider", key: "horizontalCorrections", label: "Horizontal corrections", group: "advanced", min: 0, max: 5, step: 1 },
      { type: "slider", key: "rotationAmount", label: "Rotation amount", group: "advanced", min: 0, max: 1, step: 0.05 },
      { type: "slider", key: "maxQuarterTurns", label: "Max quarter turns", group: "advanced", min: 0, max: 3, step: 1 },
      { type: "slider", key: "rotationSpeed", label: "Rotation speed", group: "advanced", min: 0, max: 1, step: 0.05 },
      { type: "slider", key: "landingBounce", label: "Landing bounce", group: "advanced", min: 0, max: 1, step: 0.05 },
      { type: "slider", key: "landingDelay", label: "Landing delay (ms)", group: "advanced", min: 0, max: 1000, step: 25 },
      { type: "slider", key: "glowDuration", label: "Glow duration (ms)", group: "advanced", min: 80, max: 800, step: 20 },
      { type: "slider", key: "finalHoldDuration", label: "Final hold (ms)", group: "advanced", min: 0, max: 3000, step: 50 },
      { type: "slider", key: "revealOutSpeed", label: "Reveal-out speed", group: "advanced", min: 0.35, max: 2, step: 0.05 },
      {
        type: "select",
      ...
      { type: "slider", key: "pieceSizePreference", label: "Piece-size preference", group: "advanced", min: 0, max: 1, step: 0.05 },
      { type: "slider", key: "tetrominoFrequency", label: "Tetromino frequency", group: "advanced", min: 0, max: 1, step: 0.05 },
      { type: "slider", key: "triominoFrequency", label: "Triomino frequency", group: "advanced", min: 0, max: 1, step: 0.05 },
      { type: "slider", key: "shapeVariety", label: "Shape variety", group: "advanced", min: 0, max: 1, step: 0.05 },
      { type: "slider", key: "edgeDetail", label: "Legacy edge bias", group: "advanced", min: 0, max: 1, step: 0.05 },

...
const RAW_PRESETS: PresetDefinition[] = [
  ...
  },
  {
    id: "blueprint",
    label: "Blueprint",
    description: "Cyanotype technical drawing — cool ink on paper grain.",
    materialId: "paper",
    componentIds: "*",
    params: {
      ditherSize: 8,
    ...
    color: {
      ...
      behavior: "none",
      colors: {
        background: { r: 0.04, g: 0.24, b: 0.38 },
        highlight: { r: 0.84, g: 0.92, b: 0.97 },
        accent: { r: 0.36, g: 0.68, b: 0.89 },
        gradientStart: { r: 0.04, g: 0.24, b: 0.38 },
        gradientEnd: { r: 0.84, g: 0.92, b: 0.97 },
      },
    },
    dither: { algorithm: "bayer", matrixSize: 8, patternScale: 1.1 },
  },
  {
    id: "terminal-green",
    label: "Terminal",
    description: "Phosphor terminal readouts — CRT scan with digital grit.",
    materialId: "crt",
    componentIds: ["card", "badge", "input", "loader"],
    params: {
      ditherSize: 4,
      contrast: 1.35,
      bloom: 0.35,
    ...
    color: {
      ...
      behavior: "none",
      colors: {
        background: { r: 0.01, g: 0.1, b: 0.04 },
        highlight: { r: 0.22, g: 1, b: 0.08 },
        accent: { r: 0.05, g: 0.36, b: 0.18 },
        glow: { r: 0.22, g: 1, b: 0.08 },
      },
    },
    dither: { algorithm: "bayer", matrixSize: 4 },
  },
  {
    id: "aurora",
    label: "Aurora",
    ...
    material: {
      materialId: "fog",
      params: { structureAmount: 0.65, softness: 0.7 },
    },
    animation: { modeId: "aurora" },
    color: {
      colorEnabled: true,
      behavior: "none",
      colors: {
        background: { r: 0.04, g: 0.07, b: 0.17 },
        highlight: { r: 0.36, g: 0.75, b: 0.75 },
        accent: { r: 0.23, g: 0.31, b: 0.42 },
        glow: { r: 0.45, g: 0.85, b: 0.7 },
      },
    },
    dither: { algorithm: "blue-noise", matrixSize: 8, distribution: 0.85 },
  },
  {
    id: "ocean-depth",
    label: "Ocean",
    description: "Deep water pressure — cool velvet with slow wave motion.",
    materialId: "velvet",
    componentIds: "*",
    params: {
      ditherSize: 8,
    ...
    material: {
      materialId: "velvet",
      params: { structureAmount: 0.7, absorption: 0.55 },
    },
    animation: { modeId: "wave" },
    color: {
      colorEnabled: true,
      behavior: "none",
      colors: {
        background: { r: 0.0, g: 0.16, b: 0.29 },
        highlight: { r: 0.56, g: 0.88, b: 0.94 },
        accent: { r: 0.0, g: 0.47, b: 0.71 },
      },
    },
    dither: { algorithm: "halftone", matrixSize: 8, cellSize: 0.4, angle: 15 },
  },
  {
    id: "infrared",
    label: "Infrared",
    description: "False-color heat map aesthetic with posterized dither.",
    materialId: "monochrome",
    componentIds: "*",
    params: {
      ditherSize: 8,
    ...
    color: {
      ...
      behavior: "none",
      colors: {
        background: { r: 0.1, g: 0.0, b: 0.08 },
        highlight: { r: 1, g: 0.0, b: 0.43 },
        accent: { r: 0.98, g: 0.34, b: 0.03 },
        glow: { r: 1, g: 0.2, b: 0.3 },
      },
    },
    dither: { algorithm: "posterized", matrixSize: 8, patternScale: 1 },
  },
  {
    id: "heat-map",
    label: "Heat",
    ...
    material: {
      materialId: "metal",
      params: { structureAmount: 0.5, reflectivity: 0.45 },
    },
    color: {
      colorEnabled: true,
      behavior: "none",
      gradientMode: "quad",
      colors: {
        background: { r: 0.01, g: 0.004, b: 0.03 },
        highlight: { r: 1, g: 0.97, b: 0.91 },
        shadow: { r: 0.04, g: 0.016, b: 0.09 },
        dither: { r: 0.88, g: 0.25, b: 0.09 },
        bloom: { r: 1, g: 0.72, b: 0.2 },
        ambient: { r: 0.22, g: 0.06, b: 0.28 },
        accent: { r: 1, g: 0.28, b: 0.12 },
        gradientStart: { r: 0.05, g: 0.03, b: 0.16 },
        gradientMid: { r: 0.56, g: 0.06, b: 0.63 },
        gradientFourth: { r: 1, g: 0.16, b: 0.09 },
        gradientEnd: { r: 1, g: 0.69, b: 0.12 },
        glow: { r: 1, g: 0.88, b: 0.38 },
        edgeTint: { r: 1, g: 0.56, b: 0.25 },
        noiseTint: { r: 0.25, g: 0.06, b: 0.38 },
      },
    },
    dither: { algorithm: "bayer", matrixSize: 8 },
  },
  {
    id: "paper-stock",
    label: "Paper",
    description: "Clean print stock — fiber grain with soft ink holdout.",
    materialId: "paper",
    componentIds: "*",
    params: {
      ditherSize: 8,

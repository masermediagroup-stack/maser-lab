...
export const COMPONENTS: ComponentDefinition[] = [
  ...
  },
  {
    ...
    label: "Image Frame",
    category: "media",
    description: "Upload a photo and recreate it with the shared dither engine.",
    purpose: "Present photography through ordered dither + material language.",
    bestUses: ["Galleries", "Case studies", "Brand stills"],
    performanceNotes: "One source texture (unit 6); cover-fit UV; no per-thumb contexts.",
    a11yNotes: "Canvas aria-label reflects sourced vs empty; caption below.",
    mobileNotes: "Stack caption below; prefer compressed JPEG/WebP uploads.",
    status: "ready",
    defaultPresetId: "print-density",
  },
  {
